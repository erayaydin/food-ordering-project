package in.yayd.era.food.ordering.project.payment.service.messaging.listener.kafka;

import in.yayd.era.food.ordering.project.kafka.consumer.KafkaConsumer;
import in.yayd.era.food.ordering.project.kafka.order.avro.model.PaymentOrderStatus;
...
import in.yayd.era.food.ordering.project.payment.service.domain.ports.input.message.listener.PaymentRequestMessageListener;
...
public class PaymentRequestKafkaListener implements KafkaConsumer<PaymentRequestAvroModel> {
    ...
    public void receive(
        ...
        log.info("{} number of payment requests received with keys:{}, partitions:{} and offsets: {}", messages.size(), keys.toString(), partitions.toString(), offsets.toString());
