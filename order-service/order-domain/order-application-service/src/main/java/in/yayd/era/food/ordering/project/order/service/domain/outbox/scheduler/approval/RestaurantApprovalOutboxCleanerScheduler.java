...
public class RestaurantApprovalOutboxCleanerScheduler implements OutboxScheduler {
    ...
    public void processOutboxMessage() {
        ...
        if (outboxMessagesResponse.isPresent()) {
            ...
            log.info("Received {} OrderApprovalOutboxMessage for clean-up. The payloads: {}", outboxMessages.size(), outboxMessages.stream().map(OrderApprovalOutboxMessage::getPayload).collect(Collectors.joining("\n")));
