...
public class CustomerKafkaListener implements KafkaConsumer<CustomerAvroModel> {
    ...
    public void receive(
        ...
        log.info("{} number of customer create messages received with keys {}, partitions {} and offsets {}", messages.size(), keys.toString(), partitions.toString(), offsets.toString());
