package in.yayd.era.food.ordering.project.restaurant.service.domain.outbox.scheduler;
...
import in.yayd.era.food.ordering.project.restaurant.service.domain.exception.RestaurantDomainException;
...
import static in.yayd.era.food.ordering.project.saga.order.SagaConstants.ORDER_SAGA_NAME;
...
public class OrderOutboxHelper {
    ...
    public void saveOrderOutboxMessage(
        ...
        save(OrderOutboxMessage.builder()
                ...
                .processedAt(ZonedDateTime.now(ZoneId.of(DefaultTimezone)))
